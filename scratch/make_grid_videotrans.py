...
def make_grid_videotrans():
    temp_dir = "public/temp_grid_trans"
    ...
    grid_img.save("public/grid_videotrans_debug.png")
    print("Saved public/grid_videotrans_debug.png")
